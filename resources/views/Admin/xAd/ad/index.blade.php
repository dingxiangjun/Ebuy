            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a type="button" class="am-btn am-btn-default" href="{{route('admin.xAd.ad.create')}}">
                                    ...
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
                                               href="{{route('admin.xAd.ad.edit', $ad->id)}}">
                                                <span class="am-icon-pencil-square-o"></span> 编辑
                                            </a>

                                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                                               href="{{route('admin.xAd.ad.destroy', $ad->id)}}"
                                               data-method="delete"
    ...
    <script>
        $(function () {
            ...
            $('#destroy_checked').click(function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "/admin/xAd/ad/destroy_checked",
                    data: checked_id,
                    success: function () {
            ...
            $("#change_category").change(function () {
                ...
                if (category_id == "-1") {
                    location.href = "{{route('admin.xAd.ad.index')}}";
                    return false;
                }
                var url = "/admin/xAd/ad?category_id=" + category_id;
                location.href = url;
            })
        });
    </script>
