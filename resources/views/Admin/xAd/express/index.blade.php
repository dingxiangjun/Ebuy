        ...
        <div class="am-u-sm-12 am-u-md-6">
            <div class="am-btn-toolbar">
                <div class="am-btn-group am-btn-group-xs">
                    <a class="am-btn am-btn-default" href="{{route('admin.xEbuy.express.create')}}">
                    ...
                    <thead>
                        ...
                        <tr data-id="{{$express->id}}">
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="{{route('admin.xEbuy.express.edit',$express->id)}}">
                                            <span class="am-icon-list-alt"></span> 编辑
                                        </a>
                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" href="{{route('admin.xEbuy.express.destroy',$express->id)}}" data-method="delete" data-token="{{csrf_token()}}" data-confirm="确定删除吗？">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("input[name='sort_order']").change(function () {
                ...
                $.ajax({
                    type: "PATCH",
                    url: "/admin/xEbuy/express/sort_order",
                    data: data,
                });
            })
            ...
            $(".is_something").click(function () {
                ...
                $.ajax({
                    type: "PATCH",
                    url: "/admin/xEbuy/express/is_something",
                    data: data,
                    success: function () {
