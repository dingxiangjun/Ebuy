                                        ...
                                        <tr>
                                            <th class="col-main">
                                                <p class="caption-info">{{$order->created_at->format('Y年m月d日 H:i')}}
                                                    <span class="sep">|</span>
                                                    {{$order->address->name}} (<a href="tel:{{$order->address->tel}}">{{$order->address->tel}}</a>)
                                                    <span class="sep">|</span>
                                            ...
                                            <th class="col-sub">
                                                <p class="caption-price">订单金额：<span
                                                            class="num">{{doubleval($order->total_price)}}</span>元</p>
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                                ...
                                                <ul class="goods-list">
                                                    ...
                                                    @foreach($order->order_products as $order_product)
                                                        ...
                                                        <li>
                                                            ...
                                                            <p class="price">{{doubleval($order_product->product->price)}}元
                                            ...
                                            <td class="order-actions">
                                                <a class="btn btn-small btn-line-gray"
                                                   href="{{ route('admin.xEbuy.order.show', $order->id) }}">订单详情</a>
                                                {{--<a class="btn btn-small btn-line-gray"--}}
                                                   {{--href="http://service.order.mi.com/cservice/stepone/id/1150426350013010"--}}
