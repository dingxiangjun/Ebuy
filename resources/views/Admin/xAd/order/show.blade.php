                    ...
                    <div class="uc-content-box order-view-box">
                        <div class="box-hd">
                            ...
                            <div class="more clearfix">
                                ...
                                {{--<div class="actions">--}}
                                {{--<a title="申请售后" href="http://service.order.mi.com/cservice/stepone/id/1150426350013010" class="btn btn-small btn-line-gray"  >申请售后</a>                    --}}
                                {{--</div>--}}
                            </div>
                        </div>
                        <div class="box-bd">
                                    ...
                                    <div class="order-summary">
                                        ...
                                        @if($order->status >= 4)
                                            ...
                                            <a class="order-delivery-trigger J_deliveryTrigger has-result toggled"
                                               href="javascript: void(0);">展开物流详情 <i class="iconfont am-icon-angle-down"></i></a>
                                        @endif
