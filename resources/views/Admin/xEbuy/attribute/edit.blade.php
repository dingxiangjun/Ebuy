        ...
        <div class="admin-content-body">
            ...
            <form class="am-form" method="post" action="{{ route('admin.xEbuy.attribute.update',$attribute->id) }}">
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                        <input type="text" name="attr_name" value="{{$attribute->attr_name}}" class="am-input-sm">
                    </div>
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="am-u-sm-8 am-u-md-4">
                        <label class="am-radio-inline">
                            <input type="radio" value="0" name="attr_type" @if($attribute->attr_type == 0) checked @endif> 唯一
                        </label>
                        <label class="am-radio-inline">
                            <input type="radio" value="1" name="attr_type" @if($attribute->attr_type == 1) checked @endif> 可选
                        </label>
                    </div>
