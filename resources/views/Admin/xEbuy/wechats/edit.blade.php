        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/xShop/wechat/menu" class="am-btn am-btn-default" id="destroy_checked"
                           data-method="delete"
            ...
            <div class="am-u-sm-12 am-u-md-12">
                ...
                <div class="am-tab-panel">
                    ...
                    <form class="am-form " action="/xShop/wechat" method="post">
                        {!! csrf_field() !!}
                        {!! method_field('put') !!}
                        ...
                        <div class="am-tabs" data-am-tabs style="margin:1.6rem 0;">
                            ...
                            <div class="am-tabs-bd">
                                @for ($i = 0; $i < 3; $i++)
                                    ...
                                    ?>
                                    @include('Admin.xShop.wechats._menus', ['button' => $button, 'index'=>$i])
                                @endfor
                            </div>
                        </div>
